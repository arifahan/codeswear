      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-5 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:w-1/2 w-full lg:h-auto px-24 md:px-40 object-cover object-top rounded"
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0 flex flex-col justify-center">
              ...
              <div className="flex ">
                <p className="title-font font-medium text-xl md:text-2xl text-gray-900 ">
                  Tk.599.00
                </p>
                <button className="flex ml-2 text-white bg-pink-500 border-0 py-2 px-1 md:px-6 focus:outline-none hover:bg-pink-600 rounded">
                  Buy Now
                </button>
                <button
                  onClick={() => {
              ...
              <div className="pin mt-6 flex">
                <input
                  ...
                  type="text"
                  placeholder="Input your pin here"
                  className="px-2 border-2 rounded border-gray-400"
                ></input>
                <button
              ...
              {!service && service != null && (
                <div className="text-red-700 font-bold text-sm mt-3">
